...
func TestSubRouteExtracting(t *testing.T) {
	...
	apiMux := New()
	result := ""
	apiMux.Get("/test", func(rw http.ResponseWriter, req *http.Request) {
...
func TestMux_PrefixFunc(t *testing.T) {
	type fields struct {
...
func TestMux_GetFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.GetHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_PostFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.PostHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_PutFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.PutHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_DeleteFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.DeleteHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_HeadFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.HeadHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_PatchFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.PatchHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_OptionsFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := m.OptionsHandler(tt.args.path, tt.args.handler); !reflect.DeepEqual(got, tt.want) {
...
func TestMux_NotFoundFunc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			m.NotFoundHandler(tt.args.handler)
		})
	}
}
*/
